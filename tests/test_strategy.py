...
from src.services.market_data_service.model.OrderBook import OrderBookLevel
from src.services.order_management_service.model.Order import Orders, Order
...
from src.strategy.SampleMM import SampleMM, OrderBook, TRADING_INSTRUMENT_ID
from src.strategy.model.StrategyOrder import StrategyOrder, StrategyOrderStatus
from src.utils.OkxEnum import OrderState, OrderSide, OrderType, AccountConfigMode, InstType, TdMode
...
class TestStrategy(TestCase):
    def setUp(self) -> None:
        ...
        order_book.set_asks_on_update(OrderBookLevel(price=2, quantity=2, order_count=1, price_string="2", quantity_string="2", order_count_string="1"))
        order_book.set_bids_on_update(OrderBookLevel(price=1, quantity=1, order_count=1, price_string="1", quantity_string="1", order_count_string="1"))
